...
const TargetGroup = () => {
    return (
        <div>
            <div className="grid grid-cols-2 gap-30 my-20">
                <div className="text-5xl text-[#344499] leading-[120%]">Кому подходит решение</div>
            ...
            <div className="grid grid-cols-3 gap-7">
                <div className="px-7 pt-10 pb-15 rounded-3xl bg-main-gradient text-white">
                    <Image
                        ...
                        height={44}
                    />
                    <div className="mt-15 mb-10 text-4xl">{TARGET_INFO[0].target}</div>
                    <div className="text-xl">{TARGET_INFO[0].description}</div>
                </div>
                <div className="px-7 pt-10 pb-15 rounded-3xl bg-transparent-gradient text-[#034744]">
                    <Image
                        ...
                        height={44}
                    />
                    <div className="mt-15 mb-10 text-4xl">{TARGET_INFO[1].target}</div>
                    <div className="text-xl">{TARGET_INFO[1].description}</div>
                </div>
                <div className="px-7 pt-10 pb-15 rounded-3xl bg-transparent-gradient text-[#034744]">
                    <Image
                        src={'/blocks-icon-dark.svg'}
                        ...
                        height={44}
                    />
                    <div className="mt-15 mb-10 text-4xl">{TARGET_INFO[2].target}</div>
                    <div className="text-xl">{TARGET_INFO[2].description}</div>
                </div>
            </div>
        </div>
    );
